...
- Clone the repository or [download](https://github.com/SurjitSahoo/oshoworld-discourse-downloader/archive/refs/heads/main.zip) the package and install the dependencies with following command  
